...
#K8-preconfig AMI (use this as a replacement for the above)
variable "ami" {
  default = "ami-092bbcb0ada9fbb24"
}
...
#Name for Master Node Launch Template
variable "master_node_name"{
  default = "k8_master_lt"
}

#Name for Worker Node Launch Template
variable "worker_node_name"{
  default = "k8_worker_lt"
}

#Name for Load Balancer
variable "lb_name"{
   default = "k8-stack-lb-terraform"
}

#Name for Target Group
variable "tg_name"{
  default = "Stack-K8-ClIXX-TG"
}

#Name for Autoscaling Group for K8 Master Node
variable "k8_master_asg_name"{
  default = "k8-master-asg-terraform"
}

#Name for Autoscaling Group for K8 Worker Node
variable "k8_worker_asg_name"{
  default = "k8-worker-asg-terraform"
}
...
variable "LT_DETAILS" {
  ...
  default = {
    ...
    iam_instance_profile = "Stack_Jenkins_Role"
    resource_type_tag = "instance"
    backup_tag = "Yes"
  }
}
...
variable "ASG_DETAILS" {
  ...
  default={
    ...
    min_size_for_k8_master=1
    min_size_for_k8_worker=2
    max_size_for_k8_master=1
    max_size_for_k8_worker=2
    health_check_grace_period=300
    health_check_type="EC2"
    desired_capacity_k8_master=1
    desired_capacity_k8_worker=2
    propagate_at_launch=true
    instance_tag_key="Name"
    master_node_tag_value="Stack-Server-K8-Master"
    worker_node_tag_value="Stack-Server-K8-Worker"
  }
}
