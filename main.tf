...
module "CORE-INFO" {
 ...
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//CORE_INFO?ref=stack_modules_clixx_ecs"
...
module "EC2-BASTION-BASE" {
 #source="./MODULES/EC2"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//EC2?ref=stack_modules_clixx_ecs"
...
module "EFS-BASE"{
 #source="./MODULES/EFS"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//EFS?ref=stack_modules_clixx_ecs"
...
module "RDS-BASE"{
 #source="./MODULES/RDS"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//RDS?ref=stack_modules_clixx_ecs"
...
module "LAUNCH-TEMP-BASE"{
 ...
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//LAUNCH_TEMP?ref=stack_modules_clixx_ecs"
...
module "ASG-LB-BASE"{
 ...
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//ASG_LB?ref=stack_modules_clixx_ecs"
 ...
 ecs_cluster_name=module.ECS-BASE[0].cluster_name
}

#For VPC
module "VPC-BASE"{
 #source="./MODULES/VPC"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//VPC?ref=stack_modules_clixx_ecs"
...
module "ECS-BASE"{
 #source="./MODULES/ECS"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//ECS?ref=stack_modules_clixx_ecs"
 count=var.stack_controls["ecs_create"] == "Y" ? 1:0
 tg_arn=module.ASG-LB-BASE[0].tg_arn
 cluster_name=var.cluster_name
 container_name=var.container_name
 container_image=local.container_image
 container_essential=var.container_essential
 CONT_MEMORY_PORT_MAP_DETAILS=var.CONT_MEMORY_PORT_MAP_DETAILS
 TASK_DEF_DETAILS=var.TASK_DEF_DETAILS 
 SERVICE_DETAILS=var.SERVICE_DETAILS
}
