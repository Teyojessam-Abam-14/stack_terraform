...
module "CORE-INFO" {
 ...
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//CORE_INFO?ref=stack_modules_clixx_k8"
...
module "EC2-BASTION-BASE" {
 #source="./MODULES/EC2"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//EC2?ref=stack_modules_clixx_k8"
...
module "EFS-BASE"{
 #source="./MODULES/EFS"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//EFS?ref=stack_modules_clixx_k8"
...
module "RDS-BASE"{
 #source="./MODULES/RDS"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//RDS?ref=stack_modules_clixx_k8"
...
module "LAUNCH-TEMP-BASE"{
 ...
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//LAUNCH_TEMP?ref=stack_modules_clixx_k8"
 ...
 #required_tags=module.CORE-INFO[0].all_resource_tags
 master_bootstrap_file=base64encode(data.template_file.k8_master_bootstrap.rendered)
 worker_bootstrap_file=base64encode(data.template_file.k8_worker_bootstrap.rendered)
}

#For Autoscaling group, Load Balancer and Route53
module "ASG-LB-BASE"{
 #source="./MODULES/ASG_LB"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//ASG_LB?ref=stack_modules_clixx_k8"
 ...
 tg_name=var.tg_name
 k8_master_asg_name=var.k8_master_asg_name
 k8_worker_asg_name=var.k8_worker_asg_name
 ...
 master_launch_template_id=module.LAUNCH-TEMP-BASE[0].master_launch_template_id
 worker_launch_template_id=module.LAUNCH-TEMP-BASE[0].worker_launch_template_id
...
module "VPC-BASE"{
 #source="./MODULES/VPC"
 source="git::https://github.com/Teyojessam-Abam-14/stack_terraform.git//VPC?ref=stack_modules_clixx_k8"
