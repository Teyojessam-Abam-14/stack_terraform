...
resource "aws_inspector_assessment_template" "stack_hardening_rules" {
  ...
  rules_package_arns = [
    "arn:aws:inspector:us-east-1:058264285478:rulespackage/0-gEjTy7T7",
    "arn:aws:inspector:us-east-1:058264285478:rulespackage/0-rExsr2X8",
    "arn:aws:inspector:us-east-1:058264285478:rulespackage/0-PmNV0Tcd",
    "arn:aws:inspector:us-east-1:058264285478:rulespackage/0-R01qwB5Q",
  ]
}
